...
public class CircleRefreshHeaderView extends RelativeLayout implements SwipeTrigger, SwipeRefreshTrigger {
    ...
    private void initView() {
        ...
        int circlewidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 25, getResources().getDisplayMetrics());
        ...
        mAnimation = new ImageView(getContext());
        mAnimation.setLayoutParams(circleParams);
        ...
        mAnimation.setBackgroundResource(R.drawable.loading);
        ll.addView(mAnimation);
