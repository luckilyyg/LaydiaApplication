...
public static  List<CirContents> backPDatas(){
    mList = new ArrayList<>();
    ...
    replay10.add(new Comment("1000", "权志龙", "1000", "彭于晏", "中国的教育有待重视！"));
    replay10.add(new Comment("1000", "权志龙", "1000", "尼坤", "韩国的教育有待重视！"));
    replay10.add(new Comment("1000", "赵雅芝", "1000", "汪涵", "美国的教育有待重视！"));
    replay10.add(new Comment("1000", "何炅", "1000", "沙溢", "德国的教育有待重视！"));
    ...
    public static List<CirContents> loadDatas(){
        mList = new ArrayList<>();
        List<Favort> goodjobs1 = new ArrayList<>();
        goodjobs1.add(new Favort("张三三", "10000"));
        goodjobs1.add(new Favort("李四四", "144444"));
        goodjobs1.add(new Favort("王老五五", "12222"));
        List<Favort> goodjobs2 = new ArrayList<>();
        goodjobs2.add(new Favort("范冰冰", "10000"));
        goodjobs2.add(new Favort("李冰冰", "144444"));
        List<Favort> goodjobs3 = new ArrayList<>();
